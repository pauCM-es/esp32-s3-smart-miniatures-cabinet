const N = globalThis, O = N.ShadowRoot && (N.ShadyCSS === void 0 || N.ShadyCSS.nativeShadow) && "adoptedStyleSheets" in Document.prototype && "replace" in CSSStyleSheet.prototype, tt = /* @__PURE__ */ Symbol(), j = /* @__PURE__ */ new WeakMap();
let lt = class {
  constructor(t, e, i) {
...
const et = (s) => new lt(typeof s == "string" ? s : s + "", void 0, tt), ct = (s, t) => {
  if (O) s.adoptedStyleSheets = t.map((e) => e instanceof CSSStyleSheet ? e : e.styleSheet);
...
}, V = O ? (s) => s : (s) => s instanceof CSSStyleSheet ? ((t) => {
  let e = "";
  for (const i of t.cssRules) e += i.cssText;
  return et(e);
})(s) : s;
const { is: dt, defineProperty: ht, getOwnPropertyDescriptor: pt, getOwnPropertyNames: ut, getOwnPropertySymbols: mt, getPrototypeOf: gt } = Object, R = globalThis, B = R.trustedTypes, ft = B ? B.emptyScript : "", vt = R.reactiveElementPolyfillSupport, A = (s, t) => s, I = { toAttribute(s, t) {
  switch (t) {
    case Boolean:
      s = s ? ft : null;
      break;
  ...
  return e;
} }, it = (s, t) => !dt(s, t), F = { attribute: !0, type: String, converter: I, reflect: !1, useDefault: !1, hasChanged: it };
...
let x = class extends HTMLElement {
  ...
  _$AK(t, e) {
    ...
    if (a !== void 0 && this._$Em !== a) {
      const o = i.getPropertyOptions(a), n = typeof o.converter == "function" ? { fromAttribute: o.converter } : o.converter?.fromAttribute !== void 0 ? o.converter : I;
      this._$Em = a;
  ...
  performUpdate() {
    ...
    if (!this.hasUpdated) {
      ...
      if (i.size > 0) for (const [a, o] of i) {
        const { wrapped: n } = o, r = this[a];
        n !== !0 || this._$AL.has(a) || r === void 0 || this.C(a, void 0, o, r);
      }
    }
    let t = !1;
    const e = this._$AL;
...
x.elementStyles = [], x.shadowRootOptions = { mode: "open" }, x[A("elementProperties")] = /* @__PURE__ */ new Map(), x[A("finalized")] = /* @__PURE__ */ new Map(), vt?.({ ReactiveElement: x }), (R.reactiveElementVersions ??= []).push("2.1.2");
const U = globalThis, Z = (s) => s, z = U.trustedTypes, W = z ? z.createPolicy("lit-html", { createHTML: (s) => s }) : void 0, at = "$lit$", f = `lit$${Math.random().toFixed(9).slice(2)}$`, st = "?" + f, bt = `<${st}>`, _ = document, E = () => _.createComment(""), T = (s) => s === null || typeof s != "object" && typeof s != "function", q = Array.isArray, _t = (s) => q(s) || typeof s?.[Symbol.iterator] == "function", P = `[ 	
\f\r]`, S = /<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g, G = /-->/g, X = />/g, v = RegExp(`>|${P}(?:([^\\s"'>=/]+)(${P}*=${P}*(?:[^ 	
\f\r"'\`<>=]|("|')|))|$)`, "g"), J = /'/g, Q = /"/g, ot = /^(?:script|style|textarea|title)$/i, xt = (s) => (t, ...e) => ({ _$litType$: s, strings: t, values: e }), m = xt(1), y = /* @__PURE__ */ Symbol.for("lit-noChange"), u = /* @__PURE__ */ Symbol.for("lit-nothing"), K = /* @__PURE__ */ new WeakMap(), b = _.createTreeWalker(_, 129);
function nt(s, t) {
...
const yt = (s, t) => {
  ...
  let a, o = t === 2 ? "<svg>" : t === 3 ? "<math>" : "", n = S;
  for (let r = 0; r < e; r++) {
    const c = s[r];
    let d, h, l = -1, p = 0;
    for (; p < c.length && (n.lastIndex = p, h = n.exec(c), h !== null); ) p = n.lastIndex, n === S ? h[1] === "!--" ? n = G : h[1] !== void 0 ? n = X : h[2] !== void 0 ? (ot.test(h[2]) && (a = RegExp("</" + h[2], "g")), n = v) : h[3] !== void 0 && (n = v) : n === v ? h[0] === ">" ? (n = a ?? S, l = -1) : h[1] === void 0 ? l = -2 : (l = n.lastIndex - h[2].length, d = h[1], n = h[3] === void 0 ? v : h[3] === '"' ? Q : J) : n === Q || n === J ? n = v : n === G || n === X ? n = S : (n = v, a = void 0);
    const g = n === v && s[r + 1].startsWith("/>") ? " " : "";
    o += n === S ? c + bt : l >= 0 ? (i.push(d), c.slice(0, l) + at + c.slice(l) + f + g) : c + f + (l === -2 ? r : g);
  }
...
class M {
  constructor({ strings: t, _$litType$: e }, i) {
    ...
    this.parts = [];
    let o = 0, n = 0;
    const r = t.length - 1, c = this.parts, [d, h] = yt(t, e);
    if (this.el = M.createElement(d, i), b.currentNode = this.el.content, e === 2 || e === 3) {
      const l = this.el.content.firstChild;
      l.replaceWith(...l.childNodes);
    }
    for (; (a = b.nextNode()) !== null && c.length < r; ) {
      if (a.nodeType === 1) {
        if (a.hasAttributes()) for (const l of a.getAttributeNames()) if (l.endsWith(at)) {
          const p = h[n++], g = a.getAttribute(l).split(f), w = /([.?@])?(.*)/.exec(p);
          c.push({ type: 1, index: o, name: w[2], strings: g, ctor: w[1] === "." ? wt : w[1] === "?" ? St : w[1] === "@" ? At : H }), a.removeAttribute(l);
        } else l.startsWith(f) && (c.push({ type: 6, index: o }), a.removeAttribute(l));
        if (ot.test(a.tagName)) {
          const l = a.textContent.split(f), p = l.length - 1;
          if (p > 0) {
            a.textContent = z ? z.emptyScript : "";
            for (let g = 0; g < p; g++) a.append(l[g], E()), b.nextNode(), c.push({ type: 2, index: ++o });
            a.append(l[p], E());
          }
        }
        ...
        let l = -1;
        for (; (l = a.data.indexOf(f, l + 1)) !== -1; ) c.push({ type: 7, index: o }), l += f.length - 1;
      }
      o++;
    }
  }
...
function $(s, t, e = s, i) {
  ...
  return a?.constructor !== o && (a?._$AO?.(!1), o === void 0 ? a = void 0 : (a = new o(s), a._$AT(s, e, i)), i !== void 0 ? (e._$Co ??= [])[i] = a : e._$Cl = a), a !== void 0 && (t = $(s, a._$AS(s, t.values), a, i)), t;
}
class $t {
  constructor(t, e) {
  ...
  u(t) {
    const { el: { content: e }, parts: i } = this._$AD, a = (t?.creationScope ?? _).importNode(e, !0);
    b.currentNode = a;
    let o = b.nextNode(), n = 0, r = 0, c = i[0];
    for (; c !== void 0; ) {
      if (n === c.index) {
        let d;
        c.type === 2 ? d = new C(o, o.nextSibling, this, t) : c.type === 1 ? d = new c.ctor(o, c.name, c.strings, this, t) : c.type === 6 && (d = new kt(o, this, t)), this._$AV.push(d), c = i[++r];
      }
      n !== c?.index && (o = b.nextNode(), n++);
    }
    return b.currentNode = _, a;
  }
  p(t) {
    let e = 0;
...
class C {
  ...
  _$AI(t, e = this) {
    t = $(this, t, e), T(t) ? t === u || t == null || t === "" ? (this._$AH !== u && this._$AR(), this._$AH = u) : t !== this._$AH && t !== y && this._(t) : t._$litType$ !== void 0 ? this.$(t) : t.nodeType !== void 0 ? this.T(t) : _t(t) ? this.k(t) : this._(t);
  }
  O(t) {
  ...
  _(t) {
    this._$AH !== u && T(this._$AH) ? this._$AA.nextSibling.data = t : this.T(_.createTextNode(t)), this._$AH = t;
  }
  $(t) {
  ...
  _$AC(t) {
    ...
    return e === void 0 && K.set(t.strings, e = new M(t)), e;
  }
  k(t) {
...
class H {
  ...
  _$AI(t, e = this, i, a) {
    ...
    let n = !1;
    if (o === void 0) t = $(this, t, e, 0), n = !T(t) || t !== this._$AH && t !== y, n && (this._$AH = t);
    else {
      const r = t;
      let c, d;
      for (t = o[0], c = 0; c < o.length - 1; c++) d = $(this, r[i + c], e, c), d === y && (d = this._$AH[c]), n ||= !T(d) || d !== this._$AH[c], d === u ? t = u : t !== u && (t += (d ?? "") + o[c + 1]), this._$AH[c] = d;
    }
    n && !a && this.j(t);
  }
  j(t) {
...
Et?.(M, C), (U.litHtmlVersions ??= []).push("3.3.3");
const Tt = (s, t, e) => {
...
k._$litElement$ = !0, k.finalized = !0, D.litElementHydrateSupport?.({ LitElement: k });
...
class It extends k {
  ...
  async _action(t) {
    ...
    if (e === "select-shelf")
      ...
      if (this._mappingStart === null || this._mappingEnd !== null)
        ...
        await this._command({ action: "previewLocation", shelf: this._selectedShelf, location: this._selectedLocation, start_led: a, leds: Math.abs(this._mappingEnd - this._mappingStart) + 1 });
      }
      this._render();
      ...
      const i = this._miniatures.find((a) => a.id === t.dataset.id);
  ...
  _ledMappingContent(t, e) {
    const i = t.total_leds, a = Math.ceil(i / 2), o = t.mirrored ? [[...Array(a).keys()].reverse(), [...Array(i - a).keys()].map((l) => a + l)] : [[...Array(a).keys()], [...Array(i - a).keys()].map((l) => i - 1 - l)], n = this._mappingStart ?? (e?.mapped ? e.start_led : null), r = this._mappingEnd ?? (e?.mapped ? e.start_led + e.leds - 1 : null), c = (l) => l.map((p) => {
      const g = n !== null && r !== null && p >= Math.min(n, r) && p <= Math.max(n, r);
      return `<button class="led-cell ${this._showAllMappings && (t.locations || []).some((L) => L.mapped && p >= L.start_led && p < L.start_led + L.leds) ? "assigned" : ""} ${g ? "selected" : ""}${p === n ? " range-start" : p === r ? " range-end" : ""}" data-action="select-led" data-led="${p}" title="LED ${p + 1}"><i></i>${p % 5 === 0 ? `<small>${p + 1}</small>` : ""}</button>`;
  ...
  _bindViewDial() {
    ...
    t.onpointerdown = (c) => {
      ...
      d !== a && (a = d, this._setViewIndex(i + d));
    };
    const r = () => {
  ...
  _bindMappingLocationDial() {
    ...
    if (!t || !e) return;
    let i = 0, a = 0, o = 0, n = !1, r = !1;
    t.onpointerdown = (d) => {
      n = !0, r = !1, i = d.clientX, a = this._selectedLocation - 1, o = 0, t.setPointerCapture?.(d.pointerId), t.classList.add("dragging");
    }, t.onpointermove = (d) => {
      if (!n) return;
  ...
  async _saveMini() {
    ...
    if (!t) return;
    const a = this._miniatures.find((o) => o.id === this._editingMiniId);
  ...
  async _updateSearch(t) {
    ...
    o.textContent = `${d.length} result${d.length === 1 ? "" : "s"} ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â· ${h.length} assigned`, a.innerHTML = d.map((l) => `
...
customElements.define("ha-panel-smart-cabinet", It);
