...
lv_color_t ui_color_bg(void)        { return lv_color_hex(0x0B0F12); }
lv_color_t ui_color_surface(void)   { return lv_color_hex(0x151B20); }
lv_color_t ui_color_surface_alt(void){ return lv_color_hex(0x1B2329); }
lv_color_t ui_color_border(void)    { return lv_color_hex(0x2B353C); }
lv_color_t ui_color_accent(void)    { return lv_color_hex(0x56BDD0); }
lv_color_t ui_color_text(void)      { return lv_color_hex(0xF3F6F8); }
lv_color_t ui_color_muted(void)     { return lv_color_hex(0x929DA5); }
lv_color_t ui_color_error(void)     { return lv_color_hex(0xE36D6D); }
lv_color_t ui_color_success(void)   { return lv_color_hex(0x67C59A); }
...
void ui_theme_init(void) {
    ...
    lv_style_set_text_color(&ui_style_primary_button, lv_color_hex(0x081013));
    ...
    lv_style_set_bg_color(&ui_style_input, lv_color_hex(0x101519));
